export const queryKeys = {
  ...
  adminClientMembershipCreditLedger: (clientId, membershipId, params = {}) =>
    ['admin', 'clients', clientId, 'memberships', membershipId, 'creditLedger', params],
  coachAgenda: {
  ...
  reports: {
    ...
    inventoryHistory: (productId, params = {}) => ['reports', 'inventoryHistory', productId, params],
    clientRetention: (params = {}) => ['reports', 'clientRetention', params],
    clientPackageHistory: (userId) => ['reports', 'clientPackageHistory', userId],
