...
export default function Flow() {
  ...
  const page = getPublicPageConfig(site.config, 'flow')
  const hero = page.hero ?? {}
  const KNOWN_FLOW_IDS = new Set(['concept', 'philosophy', 'quote', 'methodology', 'benefits', 'ideal'])
  ...
  const extraSections = (page.sections ?? []).filter((s) => !KNOWN_FLOW_IDS.has(s.id) && s.isActive !== false)
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.logoGroup}>
            ...
            <img src={resolveSiteMediaUrl(hero.logo)} alt={hero.logoAlt ?? 'Slow'} className={styles.heroLogo} />
